...
FCKConfig.Plugins.Add( 'ambersky_image' ) ;
FCKConfig.Plugins.Add( 'ambersky_link' ) ;
FCKConfig.Plugins.Add( 'ambersky_typograph' ) ;
...
FCKConfig.ToolbarSets["Default"] = [
	...
	['Cut','Copy','Paste','PasteText','PasteWord'],
	['Undo','Redo','-','Find','Replace','-','SelectAll','RemoveFormat'],
	['Link','ambersky_link','Unlink','Anchor'],
	['ambersky_image','Table','SpecialChar'],
	'/',
	['FontFormat','Bold','Italic','Underline','StrikeThrough','-','Subscript','Superscript'],
	['OrderedList','UnorderedList','-','Outdent','Indent'],
	['JustifyLeft','JustifyCenter','JustifyRight','JustifyFull', 'ambersky_typograph']
] ;
